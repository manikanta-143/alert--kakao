...
class ViewProfile extends React.Component {
    ...
    _loadInitialState = async () => {
        ...
        var phonenumber = await AsyncStorage.getItem('phone');
                                ...
                                <View style={{ marginBottom: 20, marginTop: 10, flex: 5, flexDirection: 'column' }}>
                                    <View style={{ flex: 7, flexDirection: 'row', marginTop: 20, }}>
                                        ...
                                        <View style={styles.middle1}>
                                            ...
                                            <Text style={styles.textfield}>{this.state.name}</Text>
                                        </View>
                                        <View style={styles.right}>
                                            <Pencil active name="pencil" size={20} style={{ marginTop: 10, marginRight: 5, }} onPress={() => this.props.navigation.navigate('EditProfile')} />
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ flex: 7, flexDirection: 'row', marginTop: 20, }}>
                                        ...
                                        <View style={styles.middle1}>
                                            ...
                                            <Text style={styles.textfield}>{this.state.email}</Text>
                                        </View>
                                        <View style={styles.right}>
                                    ...
                                    <View style={{ flex: 7, flexDirection: 'row', marginTop: 20, }}>
                                        ...
                                        <View style={styles.middle1}>
                                            ...
                                            <Text style={styles.textfield}>{this.state.phonenumber}</Text>
                                        </View>
                                        <View style={styles.right}>
                                            <Pencil active name="pencil" size={20} style={{ marginTop: 10, marginRight: 5 }} />
                                        </View>
