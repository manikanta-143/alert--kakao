...
//  }
  ...
  checkBoxChanged(id, value, user) {
    ...
    if (value) {
      ...
      console.log(this.state.selectedValue,'final')
    }
  }
  toggleSelectAll() {
   ...
   if(this.state.visible){
    ...
    if (!this.state.checkBoxChecked[user.phoneMemberId]) {
      ...
      // alert(user)
      this.state.selectedValue.push(...this.state.selectedValue,user)
      // this.setState({ selectedValue: [...selectedValue, user] })
    }
            ...
            <ImageBackground source={Bg_Img} style={styles.backgroundContainer}>
              ...
              >
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                  ...
                  <ToggleSwitch
                    isOn={!visible}
                    label={!visible ? "select all" : "Deselect all"}
                  ...
                  />
                  <Button title="Removeall" onPress={() => this.RemoveAll()}/>
                </View>
