...
//  }
  ...
  toggleSelectAll() {
    // this.setState({ visible: !this.state.checkBoxChecked.some(e => e == false) }, () => {
    //   if (!this.state.visible) {
    //     console.log('here');
    //     this.setState({ selectedValue: [], checkBoxChecked: [] });
    //   } else {
      //  this.state.groupData.map(e => this.state.selectedValue.push(e))
      this.state.groupData.forEach(user =>{
        const { checkBoxChecked, selectedValue } = this.state;
        var tempCheckBoxChecked = checkBoxChecked;
        tempCheckBoxChecked[user.phoneMemberId] = !this.state.checkBoxChecked[user.phoneMemberId];
        this.setState({ checkBoxChecked: tempCheckBoxChecked }, () => console.log(this.state.checkBoxChecked));
        if (this.state.checkBoxChecked[user.phoneMemberId]) {
          var index = selectedValue.findIndex(function (o) {
            return o.phoneMemberId === user.phoneMemberId;
          })
          if (index !== -1) selectedValue.splice(index, 1);
        } else {
          this.state.selectedValue.push(...selectedValue,user);
          // this.setState({ selectedValue: [...selectedValue, user] })
        }
      })
    //   }
  ...
  //      [...tempCheckValues[user.phoneMemberId]] = false 
  //     console.log(user,'here the user list')
  //     return  this.checkBoxChanged(user.phoneMemberId, this.state.checkBoxChecked[user.phoneMemberId], user)
  //     // this.checkBoxChanged.bind(this,user.phoneMemberId, this.state.checkBoxChecked[user.phoneMemberId], user) && this.state.checkBoxChecked[user.phoneMemberId]
  //   })
 changeState = () =>{
   this.setState({ iconValue : !this.state.iconValue})
 }
              ...
              >
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                  ...
                  {/* <ToggleSwitch
                    ...
                    onToggle={() => this.toggleSelectAll()}
                  /> */}
                  <Button title="clickme" onPress={() => this.toggleSelectAll()}/>
                </View>
              ...
              <View style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center' }}>
                  ...
                  >
                    <MenuItem
                     ...
                     >Edit</MenuItem>
                    <MenuDivider />
                    <MenuItem onPress={this.DeleteUser} >Remove {this.state.name}
