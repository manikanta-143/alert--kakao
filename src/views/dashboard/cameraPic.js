...
export default class CameraScreen extends React.Component {
  ...
  async componentWillMount() {
    ...
    // const id = await this.props.navigation.state.params.Gid;
  ...
  onPictureSaved = async photo => {
    ...
    await this.setState({ uri: photo.uri})
    await this.toggleView();
//     await this.props.navigation.navigate('GroupIcon',{
//         groupImage: photo.uri,
//         Gid: this.state.id
//   });
  }
  ...
  renderGallery() {
    return <GalleryScreen onPress={this.toggleView.bind(this)} photoUrl={this.state.uri} id={this.props.navigation.state.params.Gid} {...this.props}/>;
  }
