...
//   if (!_.isEqual(prevState.users.length,this.state.users.length))
//   {
//     this._getAllusers();
//   }
//   }
                ...
                <View style={{ marginTop: 10, marginHorizontal: 20 }}>
                  <View style={styles.list}>
                    {users.length > 0 ?  users.map((user, i) => (
                      ...
                      />
                    )): (<Text style={{alignSelf:'center',justifyContent:'center',textAlign:'center'}}>No users to show</Text>)}
                  </View>
                </View>
              </ScrollView>
