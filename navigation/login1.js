...
import { Dimensions, Image, UIManager, StyleSheet, Text, View } from 'react-native';
...
export default class LoginScreen1 extends Component {
  ...
  async componentWillMount() {
    ...
    this.setState({ fontLoaded: true, spinner: !this.state.spinner });
  }

  render() {
    const { fontLoaded, master, user } = this.state;
